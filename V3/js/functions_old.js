...
*/
					...
					function updateStats(statYear) {
						...
						var statsPage = $('<div id="pagebody" class="statistics" />')
											.append($('<ul class="keyfigures" />')
												...
												.append('<li class="avggrant"><span>Average grant size:</span> <b>'+ parseFloat((keyFigures.avGrantNoRP / 1000000).toFixed(1))+'M SEK</b>' 
													+ ((statYear > 2013) ? '<small>(<b>'+ parseFloat((keyFigures.avGrant / 1000000).toFixed(1))+'M SEK</b> including the RP)</small>' : '') +'</li>'))
	...
	if(!is_iPhone && dropboxMonitor > 0) {
		...
		var msInterval = (typeof dropboxMonitor === 'number' && (dropboxMonitor%1) === 0) ? dropboxMonitor * 1000 : 30000; // check every 30 seconds
