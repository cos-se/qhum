...
*/
	...
	$header.append('<div id="start" class="menuitem"></div>', $('<div class="left"/>').append($selectPO, $selectRegion, $selectYear), $pages);
	...
	if(is_iPhone){
		//jQuery Touchwipe Plugin by Andreas Waltl http://www.netcu.de/jquery-touchwipe-iphone-ipad-library
